...
@Entity @Table(name="schools") class School extends Timestamped {
...
@Entity @Table(name="users") class AppUser extends Timestamped {
...
@Entity @Table(name="classes") class SchoolClass extends Timestamped {
...
@Entity @Table(name="students") class Student extends Timestamped {
  @Id @GeneratedValue(strategy=GenerationType.IDENTITY) Long id; @ManyToOne(fetch=FetchType.LAZY) @JoinColumn(name="school_id",nullable=false) School school;
...
@Entity @Table(name="fee_types") class FeeType {
  @Id @GeneratedValue(strategy=GenerationType.IDENTITY) Long id; @ManyToOne(fetch=FetchType.LAZY) @JoinColumn(name="school_id",nullable=false) School school;
